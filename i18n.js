...
const I18N = {
  es: {
    ...
    exploreAccountTitle: '¿Qué te gustaría explorar en esta cuenta?',
    insightRiesgoCritico: (label, sharePct, woh) => `${label} concentra el ${sharePct}% de la venta de la cuenta, pero su inventario ya suma cerca de ${woh} semanas — bastante por encima de lo saludable. Ahí conviene empezar a revisar el stock acumulado.`,
    insightZonaRiesgo: (lowLabel, highLabel, noun) => `${lowLabel} es tu ${noun} más importante, pero su inventario está bastante más ajustado que el de ${highLabel}, que acumula mucha más cobertura vendiendo menos. Vale la pena revisar si conviene mover profundidad de uno a otro.`,
    ...
    insightEstrellas: (label, woh) => `${label} es tu producto más fuerte este mes, pero su inventario ya bajó a ${woh} semanas. Vale la pena asegurar reabastecimiento para no perder ese impulso.`,
    insightAceleradas: (label, woh) => `${label} está entre lo más vendido y su inventario ya bajó a solo ${woh} semanas. Con el ritmo de crecimiento que trae la cuenta, vale la pena anticiparse antes de quedarte sin stock.`,
    insightRobustas: (label, sharePct, woh) => `${label} es tu categoría más fuerte (${sharePct}% de la venta), pero ya acumula ${woh} semanas de inventario. Vale la pena revisar el mix ahí antes de seguir reabasteciendo.`,
    ...
    downloadReport: 'Descargar reporte de esta cuenta',
  ...
  en: {
    ...
    exploreAccountTitle: 'What would you like to explore in this account?',
    insightRiesgoCritico: (label, sharePct, woh) => `${label} makes up ${sharePct}% of the account's sales, but its inventory is already around ${woh} weeks — well above a healthy level. That's a good place to start reviewing the buildup.`,
    insightZonaRiesgo: (lowLabel, highLabel, noun) => `${lowLabel} is your leading ${noun}, but its inventory is noticeably tighter than ${highLabel}'s, which has much more coverage while selling less. Worth checking if depth should shift from one to the other.`,
    ...
    insightEstrellas: (label, woh) => `${label} is your top seller this month, but its inventory already dropped to ${woh} weeks. Worth securing restock so you don't lose that momentum.`,
    insightAceleradas: (label, woh) => `${label} is among your best sellers and its inventory already dropped to just ${woh} weeks. Given the account's growth pace, it's worth getting ahead of a potential stockout.`,
    insightRobustas: (label, sharePct, woh) => `${label} is your strongest category (${sharePct}% of sales), but it's already carrying ${woh} weeks of inventory. Worth reviewing the mix there before restocking further.`,
    ...
    downloadReport: 'Download this account\'s report',
